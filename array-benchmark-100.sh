...
do
  ...
  target/jni-benchmarks-1.0.1-SNAPSHOT-application/jni-construction-benchmark-1.0.1-SNAPSHOT/bin/benchmark.sh --benchmark=ArrayBenchmark --csv --iterations=1000000 >> array-benchmark.csv
done
